...
contract("Token", (accounts) => {
  ...
  describe("once minted", () => {
    ...
    it("can be transferred directly", async () => {
      ...
      await token.transfer(accounts[1], 2, { from: accounts[2] }).should.be
        .rejected;
    });
    ...
    it("can be transferred indirectly", async () => {
      ...
      await token.transferFrom(accounts[0], accounts[2], 11, {
        from: accounts[1],
      }).should.be.rejected;
      await token.transferFrom(accounts[0], accounts[2], 9, {
        from: accounts[1],
      });
      ...
      await token.transferFrom(accounts[0], accounts[1], 2, {
        from: accounts[1],
      }).should.be.rejected;
    ...
    describe("can record dividends", () => {
      ...
      it("and keeps track of holders when minting and burning", async () => {
        ...
        await token
          .getWithdrawableDividend(accounts[0])
          .should.eventually.eq(0);
        await token
          .getWithdrawableDividend(accounts[1])
          .should.eventually.eq(500);
        await token
          .getWithdrawableDividend(accounts[2])
          .should.eventually.eq(1000);
      ...
      it("and keeps track of holders when transferring", async () => {
        ...
        await token
          .getWithdrawableDividend(accounts[0])
          .should.eventually.eq(250);
        await token
          .getWithdrawableDividend(accounts[1])
          .should.eventually.eq(0);
        await token
          .getWithdrawableDividend(accounts[2])
          .should.eventually.eq(750);
        await token
          .getWithdrawableDividend(accounts[3])
          .should.eventually.eq(0);
      });
      ...
      it("and compounds the payouts", async () => {
        ...
        await token
          .getWithdrawableDividend(accounts[0])
          .should.eventually.eq(250 + 0);
        await token
          .getWithdrawableDividend(accounts[1])
          .should.eventually.eq(500 + 60);
        await token
          .getWithdrawableDividend(accounts[2])
          .should.eventually.eq(250 + 30);
      });
